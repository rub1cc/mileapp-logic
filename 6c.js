// find the number that called more than once 
...
// answer
let calledMoreThanOnce = numbers.filter(number => numbers.indexOf(number) !== numbers.lastIndexOf(number))

console.log(...new Set(calledMoreThanOnce))
